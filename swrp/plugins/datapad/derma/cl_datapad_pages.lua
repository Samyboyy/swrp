...
function PANEL:Paint(width, height)
    ...
    for _, branch in ipairs(tree.branches or {}) do
        ...
        if startAngle and endAngle then
            ...
            drawSector(rootX, rootY, rootRadius + 78, outerRadius, startAngle, endAngle, Color(colour.r, colour.g, colour.b, 14), 36)
            drawSector(rootX, rootY, rootRadius + 122, math.max(rootRadius + 132, outerRadius - 34), startAngle + 2, endAngle - 2, Color(colour.r, colour.g, colour.b, 6), 36)
        end
    end
